 ...
 ***********************************************/
 void timer0_init(void) {
    ...
    TMR0H=TMR0H_BITS;            // Set initial value for 16-bit Timer 0 most significant byte (write to high reg first)
    TMR0L=TMR0L_BITS;            // Set initial value for 16-bit Timer 0 least significant byte (update happens when low reg is written to)
